...
public class StudentDao implements PreparedStatementDao<Student> {
	...
	public void insert(Student student) {
		final String query = "INSERT INTO students (first_name, last_name, age, city,email) VALUES (?, ?, ?, ?, ?)";
		try (PreparedStatement pStmt = ConnectionManager.getConnection().prepareStatement(query)) {
	...
	public void update(Student student) {
		final String query = "UPDATE students " + "SET first_name = ?, last_name = ?, age = ?, city = ?, email = ? "
				+ "WHERE id = ?";
		try (PreparedStatement pStmt = ConnectionManager.getConnection().prepareStatement(query)) {
			pStmt.setString(1, student.getFirstName());
			pStmt.setString(2, student.getLastName());
	...
	public List<Student> getByCity(String city) {
		...
		try (PreparedStatement pStmt = example.com.jdbc.lab.connection.ConnectionManager.getConnection()
	...
	public List<example.com.jdbc.lab.prepared_statement.model.Student> getByEmail(String email) {
		List<Student> students;
